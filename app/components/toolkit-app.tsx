...
export const T: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    pageRangeFormatInvalid: "페이지 번호/범위를 입력하세요. 쉼표, 세미콜론, 줄바꿈으로 구분하고 'all', 'odd', 'even', 'first', 'last', 'start', 'end', 'middle', 'center'를(을) 사용할 수 있습니다.",
  ...
  en: {
    ...
    pageRangeFormatInvalid: "Enter page numbers or ranges (comma/semicolon/newline separated). Use 'all', 'odd', 'even', 'first', 'last', 'start', 'end', 'middle', or 'center'.",
