...
export const T: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    rangeMode: "범위 지정",
    allPages: "모든 페이지 개별",
    rangePlaceholder: "예: odd, even, first, last, all, 1-3, 4-6, 7-10",
    splitRangeLabel: "분할할 페이지",
    pagesPlaceholder: "예: first, odd, 1, 2, 4-6, last",
    ...
    rotPagesPlaceholder: "예: first, even, 2, 4-6",
    wmText: "워터마크 텍스트",
    wmSize: "크기",
    wmOpacity: "투명도",
    wmAngle: "각도",
    ...
    pnTC: "상단 중앙",
    pnTR: "상단 우",
    deletePlaceholder: "삭제할 페이지 (예: first, even, 2, 5, 8-10, last)",
    deleteRangeLabel: "삭제할 페이지",
    infoInvalid: "PDF 정보를 읽을 수 없습니다.",
    pageInfoLoading: "페이지 정보 불러오는 중…",
    pageRangeFormatInvalid: "페이지 번호/범위를 입력하세요. 쉼표, 세미콜론, 줄바꿈으로 구분하고 'all', 'odd', 'even', 'first', 'last'를(을) 사용할 수 있습니다.",
  ...
  en: {
    ...
    rangeMode: "By Range",
    allPages: "Every Page",
    rangePlaceholder: "e.g. all, odd, even, first, last, 1-3, 4-6, 7-10",
    splitRangeLabel: "Pages to split",
    pagesPlaceholder: "e.g. first, odd, 1, 2, 4-6, last",
    ...
    rotPagesPlaceholder: "e.g. first, even, 2, 4-6",
    ...
    pnTC: "Top C",
    pnTR: "Top R",
    deletePlaceholder: "Pages to delete (e.g. first, even, 2, 5, 8-10, last)",
    deleteRangeLabel: "Pages to delete",
    infoInvalid: "Unable to read PDF information.",
    pageInfoLoading: "Loading page info…",
    pageRangeFormatInvalid: "Enter page numbers or ranges (comma/semicolon/newline separated). Use 'all', 'odd', 'even', 'first', or 'last'.",
